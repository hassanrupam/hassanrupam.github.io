        ...
        return (
            ...
            .map((menuItem) => (
                <div
                    ...
                    className={`${(props.activeScreen === menuItem.ID ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " bg-ub-cool-grey hover:bg-ub-cool-grey-light ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-3 focus:outline-none duration-100 my-0.5 flex justify-between items-center pl-2 pr-2 md:pl-2.5"}`}
                >
