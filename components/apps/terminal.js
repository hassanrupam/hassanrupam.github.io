...
import { APPLICATION_EVENTS, APPLICATION_UNIQUE_ID } from '../../apps.config';
...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["hassanrupam-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">rupam@ROG-Zephyrus G14</div>
    ...
    closeTerminal = () => {
        $("#close-terminal").trigger(APPLICATION_EVENTS.CLICK);
    }
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/rupam")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-rupam, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-rupam":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-rupam");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-rupam, todoist, trash, settings, sendmsg ]";
                }
                break;
...
export const displayTerminal = (addFolder, openApp,shutDown) => {
    return <Terminal addFolder={addFolder} openApp={openApp} shutDown = {shutDown}> </Terminal>;
}