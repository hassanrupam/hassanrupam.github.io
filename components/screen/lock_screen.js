...
import { APPLICATION_EVENTS, BACKGROUND_WALLPAPERS } from '../../apps.config';
import Clock from '../util components/clock';

export default function LockScreen(props) {

    const wallpapers = BACKGROUND_WALLPAPERS;

    if (props.isLocked) {
        window.addEventListener(APPLICATION_EVENTS.CLICK, props.unLockScreen);
        window.addEventListener(APPLICATION_EVENTS.KEY_PRESS, props.unLockScreen);
    };
