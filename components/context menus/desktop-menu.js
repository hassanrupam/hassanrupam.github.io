...
import { APPLICATION_EVENTS } from '../../apps.config';
...
function DesktopMenu(props) {
    ...
    useEffect(() => {
        document.addEventListener(APPLICATION_EVENTS.FULL_SCREEN_CHANGE, checkFullScreen);
        return () => {
            document.removeEventListener(APPLICATION_EVENTS.FULL_SCREEN_CHANGE, checkFullScreen);
        };
    }, [])
